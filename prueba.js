...
const tortas = [tortaEvento = new Delicatessen(1, "../javaScript/img/torta1-250x250.jpg", "Torta para Evento", "Esta es una torta cubierta por diferentes cremas para eventos de alta concurrencia.", 500, 1),
tortaAgasajo = new Delicatessen(2, "../javaScript/img/torta2-250x250.jpeg", "Torta para Agasajo", "Esta es una torta cubierta con glace de azucar para eventos de mediana concurrencia.", 350, 1),
tortaPostre = new Delicatessen(3, "../javaScript/img/torta3-250x250.jpg", "Torta para Postres", "Esta es una torta con diferentes coberturas y tamaños para eventos de baja concurrencia.", 250, 1)];
const alfajores = [alfajorChocolateNegro = new Delicatessen(4, "../javaScript/img/alfajores1-250x250.jpg", "Alfajor Artesanal Chocolate Negro", "Alfajores cubiertos por choclate negro rellenos con dulce de leche.", 150, 1),
miniAlfajorChocolateNegro = new Delicatessen(5, "../javaScript/img/alfajores2-250x250.jpg","Mini Alfajor de Chocolate Negro", "Mini Alfajores cubirtos de chocolate negro rellenos con crema a eleccion.", 130, 1),
alfajorChocolatePremiun = new Delicatessen(6, "../javaScript/img/alfajores4-250x250.jpeg", "Alfajor de Chocolate Premiun", "Alfajores bañados en chocolate negro o blanco rellenos de dulce a eleccion." , 190, 1),
miniAlfajorChocolatePremiun = new Delicatessen(7,  "../javaScript/img/alfajores3-250x250.jpg", "Mini Alfajor de Chocolate Premiun", "Mini Alfajores cubirtos de chocolate negro rellenos con crema a eleccion.", 140, 1)];
const bombones = [bombonesChocolateNegro = new Delicatessen(8, "../javaScript/img/bombones1-250x250.jpg", "Bombones de Chocolate Negro", "Bombones bañados en chocolate negro o blanco con rellenos especiales a eleccion.", 80, 1),
bombonesChocolatePremiun = new Delicatessen(9, "../javaScript/img/bombones2-250x250.jpg", "Bombones de Chocolate Premiun", "Bombones bañados en chocolate negro rellenos de dulce de leche o cremas a eleccion.", 90, 1)];
const mercaderia = [tortas, alfajores, bombones];
//CARRITO DE COMRPAS
let carrito = [];
...
const pintarCarrito = () => {
    ...
    modalButton.onclick = () => modalCarrito.style.display = "none";
    ...
    carrito.forEach((product)=>{
        ...
        <p>$ ${product.precio}</p>
        <input type="number" min = "1" value=${product.cantidad} id="cantidad">                  
        `       
         modalCarrito.append(carritoCont);
         
         const verCantidad = document.getElementById("cantidad"); 
    ...
    modalCarrito.append(totalCarrito);
};
//ESCUCHA EVENTO CARRITO
verCarrito.onclick = pintarCarrito;
